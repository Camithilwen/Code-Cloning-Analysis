...
# Load your data
df = pd.read_csv("/Users/shreyanakum/Documents/NSF@Oulu/Code-Cloning-Analysis/src/llm-scripts/testing/RAG_vs_CodeNet_binary_results_ds8b_final2.csv")
...
# Titles and legends
plt.title('Number of Samples and Accuracy by CodeNet: Deepseek')
fig.tight_layout()
plt.savefig("deepseek_final.png")
