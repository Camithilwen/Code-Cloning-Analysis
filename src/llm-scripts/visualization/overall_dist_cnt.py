...
# Load your data
df = pd.read_csv("/Users/shreyanakum/Documents/NSF@Oulu/Code-Cloning-Analysis/src/llm-scripts/testing/RAG_vs_CodeNet_binary_results_LLAMA_final2.csv")
...
# Titles and legends
plt.title('Number of Samples and Accuracy by CodeNet: LLAMA')
fig.tight_layout()
plt.savefig("llama_final.png")
