...
for iteration in range(11):
    output = f"/projappl/project_2014646/shreya/results/RAG_vs_CodeNet_prompt_results_qwen_iteration_{iteration}.csv"
    ...
    # --- EVALUATION METRICS ---
    metrics_output = f'/projappl/project_2014646/shreya/results/metrics_qwen_prompt_iteration_{iteration}.txt'
