...
all_truth = []
all_preds = []
output = f"/projappl/project_2014646/shreya/results/RAG_vs_CodeNet_binary_results_ds_final2.csv"
...
if all_truth and all_preds:
    ...
    with open(f'/projappl/project_2014646/shreya/results/metricsv2_finl2.txt', 'w') as f:
